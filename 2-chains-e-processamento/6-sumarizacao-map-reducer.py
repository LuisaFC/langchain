...
# Cria o splitter para dividir o texto em partes menores
# chunk_size: tamanho máximo de cada parte -> maximo de 250 caracteres
# chunk_overlap: Sobreposição entre chunks consecutivos(evita perda de contexto) -> Cada chunk compartilha 70 caracteres com o anterior
splitter = RecursiveCharacterTextSplitter(
    chunk_size=250, chunk_overlap=70, 
)

# Cria os chunks, texto dividido em partes menores
